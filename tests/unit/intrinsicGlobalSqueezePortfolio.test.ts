...
describe('intrinsic global squeeze portfolio', () => {
  ...
  it('propagates the complete contracted-pressure evidence through structural outcome', async () => {
    ...
    const pressureTrace: IntrinsicContractedPressureAttemptTrace = {
      ...
      separationEvaluationCumulativeStart: 3,
      separationEvaluationCumulativeEnd: 10,
      separationEvaluationLimit: 10,
      separationEvaluationQuota: 7,
      bestRepairedLoss: 0,
      bestEndpointExact: true,
      bestEndpointSatExactZero: true,
      bestEndpointCanonicalClassification: 'sat-clear-canonical-legal',
      canonicalLegalityRequestCount: 1,
      canonicalLegalityEvaluationCount: 1,
      ...
      terminatedByFailureLimit: false,
      outcome: 'accepted',
